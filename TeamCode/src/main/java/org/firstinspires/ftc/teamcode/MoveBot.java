...
@Autonomous(name = "MoveBot", group = "Autonomous")
public class MoveBot extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        if (opModeIsActive()) {
            encoderDrive(0.3, 15, 5); // Drive backward 26 inches at 50% power, 5 second timeout
        }
    }
